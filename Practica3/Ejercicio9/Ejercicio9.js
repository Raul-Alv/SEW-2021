...
class Meteo {
    constructor(){
        this.apikey = "23a90c1275a290697706417976dacb66";
        this.tipo = "&mode=xml";
        ...
        $.ajax({
            ...
            success: function(datos){
                    ...
                    var stringDatos = '<img src= "http://openweathermap.org/img/w/'+ foto +'.png" height="64px" width="64px">';
                        ...
                        $("#tiempo").append("<h3>Datos:</h3>");
                        $("#tiempo").append(stringDatos);            
                },
            error:function(){
    ...
    verXML(c){
        this.crearElemento("h2","Datos en XML desde <a href='http://openweathermap.org'>OpenWeatherMap</a>","#visualizacion"); 
        this.crearElemento("h3",this.correcto,"#visualizacion");           
        this.crearElemento("h5","","#visualizacion"); 
        this.crearElemento("h4","Datos","#visualizacion");  
        this.crearElemento("p","","#visualizacion"); 
        this.cargarDatos(c);
